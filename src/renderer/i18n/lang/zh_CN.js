export default {
  ...
  meneTotal: '菜单栏总留言数',
  userEntry: '用户进入提示',
  userMessageNum: '收到用户消息数量',
  menuMessageNum: '菜单栏总消息数',
  waitNum: '菜单栏等待接入数',
  voicePrompt: '声音提示',
  tray: '托盘闪烁',
  task: '任务栏闪烁',
  transfer_task: '转接提示设置：',
  toBeConnected: '待接入提示设置：',
  groupPrompt: '群提示设置：',
  userPrompt: '用户提示设置：',
  messagePrompt: '留言提示设置：',
  telegramAccount: 'Telegram连接设置',
  accountStart: '需要用telegram账号发送消息【',
  accountEnd: '】给aliuge\\',
